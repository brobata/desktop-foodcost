...
public class DatabaseBackupService : IDatabaseBackupService
{
    ...
    public async Task<BackupResult> CreateBackupAsync(string? customPath = null)
    {
        ...
        var fileName = $"Desktop Food Cost_Backup_{timestamp}.json";
        ...
        try
        {
            ...
            var backup = new DatabaseBackup
            {
                ...
                Recipes = recipes,
                Entrees = entrees,
                PriceHistory = new List<Dfc.Core.Models.PriceHistory>() // Price history not needed for backups
            };
    ...
    public async Task<BackupResult> CreateCompressedBackupAsync(string? customPath = null)
    {
        try
        {
            ...
            // Create zip file
            var timestamp = DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss");
            var zipFileName = $"Desktop Food Cost_Backup_{timestamp}.zip";
    ...
    public Task<List<BackupInfo>> GetAvailableBackupsAsync()
    {
        try
        {
            ...
            var files = Directory.GetFiles(_backupDirectory, "Desktop Food Cost_Backup_*.*");
...
public class DatabaseBackup
{
    ...
    public List<Dfc.Core.Models.Ingredient> Ingredients { get; set; } = new();
    public List<Dfc.Core.Models.Recipe> Recipes { get; set; } = new();
    public List<Dfc.Core.Models.Entree> Entrees { get; set; } = new();
    public List<Dfc.Core.Models.PriceHistory> PriceHistory { get; set; } = new();
}
