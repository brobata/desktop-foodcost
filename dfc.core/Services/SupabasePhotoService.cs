...
public class SupabasePhotoService
{
    ...
    public SupabasePhotoService(ILogger<SupabasePhotoService>? logger = null)
    {
        ...
        // Local cache path: AppData/Desktop Food Cost/PhotoCache/
    ...
    private string GetLocalCachePath(string storagePath)
    {
        ...
        // photos/Ingredient/abc-123/photo.jpg -> AppData/Desktop Food Cost/PhotoCache/Ingredient/abc-123/photo.jpg
