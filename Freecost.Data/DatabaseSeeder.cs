...
public static class DatabaseSeeder
{
    ...
    /// </summary>
    public static void SeedDatabase(FreecostDbContext context)
    {
    ...
    public static void SeedLocationData(FreecostDbContext context, Guid locationId)
    {
