// Location: Freecost.Data/LocalDatabase/FreecostDbContext.cs
...
public class FreecostDbContext : DbContext
{
    ...
    public FreecostDbContext(DbContextOptions<FreecostDbContext> options)
        : base(options)
    {
    }
