// Location: Dfc.Desktop/ViewModels/AddEditIngredientViewModel.cs
...
public partial class AddEditIngredientViewModel : ViewModelBase
{
    ...
    private List<Dfc.Desktop.Controls.AllergenItemViewModel> _selectedAllergens = new();
...
";
    ...
    private void UpdateAllergens(Ingredient ingredient)
    {
        ...
        foreach (var allergen in _selectedAllergens)
        {
            ingredient.IngredientAllergens.Add(new IngredientAllergen
            {
                ...
                AllergenId = Dfc.Core.Helpers.AllergenMapper.GetAllergenId(allergen.AllergenType),
    ...
    public void SetAllergens(List<Dfc.Desktop.Controls.AllergenItemViewModel> allergens)
    {
