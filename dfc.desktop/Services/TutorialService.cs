...
public class TutorialService : ITutorialService
{
    ...
    private void RegisterDefaultTutorials()
    {
        ...
        {
            Id = "welcome",
            Name = "Welcome to Desktop Food Cost",
            Description = "Learn the basics of Desktop Food Cost",
        ...
        _tutorials["ingredients"] = new Tutorial
        {
            ...
            Steps = new List<TutorialStep>
            {
                ...
                new()
                {
                    ...
                    Description = "Desktop Food Cost automatically tracks price history. Click on any ingredient to see its price trends over time.",
        ...
        _tutorials["recipes"] = new Tutorial
        {
            ...
            Steps = new List<TutorialStep>
            {
                ...
                new()
                {
                    ...
                    Description = "As you add ingredients, Desktop Food Cost automatically calculates the total recipe cost and cost per serving.",
                    TargetControlName = null,
                    Position = TutorialPosition.Center
                },
                new()
