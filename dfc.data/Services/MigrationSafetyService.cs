...
public interface IMigrationSafetyService
{
    ...
    /// </summary>
    Task<MigrationSafetyResult> ValidateAndBackupAsync(DfcDbContext context);
}
...
public class MigrationSafetyService : IMigrationSafetyService
{
    ...
    public async Task<MigrationSafetyResult> ValidateAndBackupAsync(DfcDbContext context)
    {
        try
        {
    ...
    private async Task<bool> CanAccessDatabaseAsync(DfcDbContext context)
    {
        try
        {
    ...
    private async Task<string?> CreateBackupAsync(DfcDbContext context)
    {
        try
        {
