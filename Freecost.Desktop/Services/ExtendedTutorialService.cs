...
using System.Linq;
using TutorialModule = Freecost.Desktop.Models.TutorialModule;
using TutorialStep = Freecost.Desktop.Models.TutorialStep;
using TutorialAnnotation = Freecost.Desktop.Models.TutorialAnnotation;
using TutorialAnnotationType = Freecost.Desktop.Models.TutorialAnnotationType;
...
{
    List<Freecost.Desktop.Models.TutorialModule> GetAllModules();
    Freecost.Desktop.Models.TutorialModule? GetModuleById(string moduleId);
    Freecost.Desktop.Models.TutorialStep? GetStepById(string moduleId, string stepId);
    int GetTotalStepCount();
    (Freecost.Desktop.Models.TutorialModule?, Freecost.Desktop.Models.TutorialStep?) GetNextStep(string currentModuleId, string currentStepId);
    (Freecost.Desktop.Models.TutorialModule?, Freecost.Desktop.Models.TutorialStep?) GetPreviousStep(string currentModuleId, string currentStepId);
}

public class ExtendedTutorialService : IExtendedTutorialService
{
    private readonly List<Freecost.Desktop.Models.TutorialModule> _modules;
    ...
    public List<Freecost.Desktop.Models.TutorialModule> GetAllModules() => _modules;

    public Freecost.Desktop.Models.TutorialModule? GetModuleById(string moduleId) =>
        _modules.FirstOrDefault(m => m.Id == moduleId);

    public Freecost.Desktop.Models.TutorialStep? GetStepById(string moduleId, string stepId) =>
        GetModuleById(moduleId)?.Steps.FirstOrDefault(s => s.Id == stepId);

    public int GetTotalStepCount() =>
        _modules.Sum(m => m.Steps.Count);

    public (Freecost.Desktop.Models.TutorialModule?, Freecost.Desktop.Models.TutorialStep?) GetNextStep(string currentModuleId, string currentStepId)
    {
    ...
    public (Freecost.Desktop.Models.TutorialModule?, Freecost.Desktop.Models.TutorialStep?) GetPreviousStep(string currentModuleId, string currentStepId)
    {
        var currentModule = GetModuleById(currentModuleId);
        if (currentModule == null) return (null, null);
    ...
    private List<Freecost.Desktop.Models.TutorialModule> BuildAllTutorialModules()
    {
        return new List<Freecost.Desktop.Models.TutorialModule>
        {
    ...
    private Freecost.Desktop.Models.TutorialModule BuildGettingStartedModule()
    {
        return new Freecost.Desktop.Models.TutorialModule
        {
            Id = "getting-started",
            Name = "Getting Started",
            Description = "Learn the basics of navigating Freecost",
            Icon = "🚀",
            EstimatedMinutes = 5,
            DisplayOrder = 1,
            Steps = new List<Freecost.Desktop.Models.TutorialStep>
            {
                new Freecost.Desktop.Models.TutorialStep
                {
                    Id = "welcome",
                    Title = "Welcome to Freecost! 👋",
                    Description = "Freecost helps restaurant owners and food service professionals manage recipes, calculate costs, and track profitability. This interactive tutorial will walk you through all the key features.\n\nYou can pause and resume this tutorial anytime from Settings → Help & Learning.",
                    StepNumber = 1,
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    StepNumber = 2,
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 2, Y = 15, Width = 12, Height = 60, Animate = true },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Arrow, X = 15, Y = 20, Direction = 270, Length = 8, Text = "Quick navigation" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.CircleHighlight, X = 95, Y = 5, Width = 4, Height = 4, Animate = true },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Callout, X = 85, Y = 8, Text = "Or click here" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 0, Y = 95, Width = 100, Height = 5, Animate = true }
                    }
                }
            }
        };
    ...
    private Freecost.Desktop.Models.TutorialModule BuildIngredientModule()
    {
        return new Freecost.Desktop.Models.TutorialModule
        {
            Id = "ingredients",
            ...
            Steps = new List<Freecost.Desktop.Models.TutorialStep>
            {
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Description = "Ingredients are the building blocks of everything in Freecost. Before you can create recipes or menu items, you'll need to add your ingredients.\n\nEach ingredient tracks:\n• Name and category\n• Current price and case quantity\n• Vendor information\n• Price history over time\n• Allergen information\n• Multiple names (aliases)",
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 20, Y = 25, Text = "1" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 20, Y = 35, Text = "2" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 20, Y = 45, Text = "3" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 20, Y = 55, Text = "4" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Description = "Freecost calculates cost per unit automatically:\n\nExample: If you pay $50 for a 50lb bag of flour:\n• Current Price: $50\n• Case Quantity: 50\n• Unit: Pounds\n• Cost per pound: $1.00 (calculated automatically)\n\nWhen you use 2 pounds in a recipe, Freecost knows that costs $2.00.\n\nThis system works for any unit: pounds, gallons, ounces, each, etc.",
                    ScreenshotPath = "ingredient-pricing.png",
                    StepNumber = 3,
                    ProTip = "Always enter prices as you actually purchase them - Freecost handles the math!"
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                    Id = "categories",
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 45, Y = 12, Width = 15, Height = 8 },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Label, X = 62, Y = 14, Text = "Color-coded!" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Arrow, X = 50, Y = 5, Direction = 180, Length = 15, Text = "Search here" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 2, Y = 15, Width = 5, Height = 25, Animate = true },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 0, Y = 8, Width = 100, Height = 5, Color = "#7AB51D" }
                    }
                }
            }
        };
    ...
    private Freecost.Desktop.Models.TutorialModule BuildRecipeModule()
    {
        return new Freecost.Desktop.Models.TutorialModule
        {
            Id = "recipes",
            ...
            Steps = new List<Freecost.Desktop.Models.TutorialStep>
            {
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Description = "For each ingredient in your recipe:\n\n1. Click 'Add Ingredient'\n2. Search by name (start typing)\n3. Enter the quantity you need\n4. Select the unit\n\nFreecost automatically calculates the cost for each ingredient based on:\n• The ingredient's current price\n• The quantity you're using\n• Unit conversions (it knows 16oz = 1lb!)\n\nThe total recipe cost updates in real-time as you add ingredients.",
                    ScreenshotPath = "recipe-ingredients.png",
                    StepNumber = 3,
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Arrow, X = 85, Y = 30, Direction = 0, Length = 10, Text = "Add more" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 15, Y = 75, Width = 30, Height = 8, Animate = true, Color = "#FFB74D" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Description = "The yield tells Freecost how much the recipe makes:\n\nExamples:\n• Yield: 4, Unit: servings (makes 4 servings)\n• Yield: 1, Unit: pan (makes 1 full pan)\n• Yield: 12, Unit: cookies (makes 12 cookies)\n\nThis is crucial because Freecost divides the total recipe cost by the yield to calculate cost per serving.\n\nExample:\n• Total recipe cost: $12.00\n• Yield: 4 servings\n• Cost per serving: $3.00",
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 15, Y = 12, Width = 30, Height = 6 },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 15, Y = 20, Width = 60, Height = 6 }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
    ...
    private Freecost.Desktop.Models.TutorialModule BuildEntreeModule()
    {
        return new Freecost.Desktop.Models.TutorialModule
        {
            Id = "entrees",
            ...
            Steps = new List<Freecost.Desktop.Models.TutorialStep>
            {
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Description = "Build your entree by adding recipe components:\n\n1. Click 'Add Recipe'\n2. Search for the recipe\n3. Enter quantity (usually 1 serving)\n4. Repeat for all components\n\nExample - 'Pasta Primavera' might include:\n• 1 serving Pasta recipe\n• 0.5 serving Marinara Sauce recipe\n• 1 serving Grilled Vegetables recipe\n• 0.25 serving Parmesan Garnish recipe\n\nFreecost calculates the total cost by summing all components.",
                    ScreenshotPath = "entree-components.png",
                    StepNumber = 3,
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 5, Y = 30, Text = "1" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 5, Y = 38, Text = "2" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 5, Y = 46, Text = "3" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 5, Y = 54, Text = "4" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
    ...
    private Freecost.Desktop.Models.TutorialModule BuildDashboardModule()
    {
        return new Freecost.Desktop.Models.TutorialModule
        {
            Id = "dashboard",
            ...
            Steps = new List<Freecost.Desktop.Models.TutorialStep>
            {
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 15, Y = 20, Text = "1" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 40, Y = 20, Text = "2" },
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.NumberBadge, X = 65, Y = 20, Text = "3" }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
                ...
                new Freecost.Desktop.Models.TutorialStep
                {
                    ...
                    Annotations = new List<Freecost.Desktop.Models.TutorialAnnotation>
                    {
                        new Freecost.Desktop.Models.TutorialAnnotation { Type = Freecost.Desktop.Models.TutorialAnnotationType.Highlight, X = 10, Y = 50, Width = 80, Height = 35 }
                    }
                },
                new Freecost.Desktop.Models.TutorialStep
                {
    ...
    private Freecost.Desktop.Models.TutorialModule BuildAdvancedModule()
    {
        return new Freecost.Desktop.Models.TutorialModule
        {
            Id = "advanced",
