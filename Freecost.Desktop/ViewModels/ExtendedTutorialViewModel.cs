...
public partial class ExtendedTutorialViewModel : ViewModelBase
{
    ...
    public ExtendedTutorialViewModel()
    {
        ...
        _currentStep = new TutorialStep { Title = "Welcome", Description = "Welcome to Freecost!" };
    }
    ...
    private void LoadScreenshot()
    {
        ...
        try
        {
            var assetPath = $"avares://Freecost.Desktop/Assets/Tutorial/Screenshots/{CurrentStep.ScreenshotPath}";
